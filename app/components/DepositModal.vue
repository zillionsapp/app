    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div class="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-base-100 p-6 text-left shadow-xl transition-all">
        ...
        <div class="flex items-center justify-between mb-6">
          <h3 class="text-lg font-semibold text-white">Deposit Funds</h3>
          <button
            @click="closeModal"
        ...
        <div class="mb-6 p-3 bg-base-200 rounded-lg">
          <div class="text-sm text-white/60 mb-1">Depositing to:</div>
          <div class="font-medium text-white">{{ userEmail }}</div>
        </div>
