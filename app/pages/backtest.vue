            ...
            <div v-if="result && !loading" class="bg-base-200/60 rounded-lg shadow-md p-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <button
                  @click="analyzeTrades"
                  :disabled="analyzing"
                  class="bg-purple-600 hover:bg-purple-700 disabled:bg-gray-400 text-white font-medium py-3 px-6 rounded-md transition duration-200 flex items-center justify-center"
                >
                ...
                <button
                  ...
                  class="bg-green-600 hover:bg-green-700 disabled:bg-gray-400 text-white font-medium py-3 px-6 rounded-md transition duration-200 flex items-center justify-center"
                >
