...
export default defineEventHandler(async (event) => {
  // For public access, we'll use the configured Supabase key
  ...
  // Create a supabase client with the configured key for public access
  ...
  const { data: vaultTransactions, error: vaultTxError } = await supabase
